...
Ext.define("Ext.ux.daterange.field.DateRangeSelection",{
    ...
    dateRangeItems:function() {
        return [
            {"id":"TD", "name":"Hoje", "scope": this, "selectDateRange": function() {
                var me = this,
                    eDate = Ext.Date,
                    today = new Date();
            ...
            {"id":"LM", "name":"Último mês", "scope": this, "selectDateRange": function() {
                var me = this,
                    eDate = Ext.Date,
                    today = new Date();
            ...
            {"id":"CM", "name":"Mês atual", "scope": this, "selectDateRange": function() {
                var me = this,
                    eDate = Ext.Date,
                    today = new Date();
            ...
            {"id":"NM", "name":"Próximo mês","scope": this, "selectDateRange": function() {
                var me = this,
                    eDate = Ext.Date,
                    today = new Date();
