 ...
 */
Ext.define('AboutUs.view.calendar.dd.DropZone', {
    ...
    onNodeDrop: function(n, dd, e, data) {
        if (n && data) {
            if (data.type == 'eventdrag') {
                ...
                dt = AboutUs.view.calendar.util.Date.copyTime(rec.data[AboutUs.view.calendar.data.EventMappings.StartDate.name], n.date);
