 ...
 */
Ext.define('AboutUs.view.calendar.dd.DayDropZone', {
    extend: 'AboutUs.view.calendar.dd.DropZone',
    requires: [
    ...
    onNodeOver: function(n, dd, e, data) {
        ...
        if (data.type == 'caldrag') {
            ...
            curr = AboutUs.view.calendar.util.Date.copyTime(n.date, this.dragCreateDt);
            this.dragStartDate = AboutUs.view.calendar.util.Date.min(this.dragCreateDt, curr);
            this.dragEndDate = endDt || AboutUs.view.calendar.util.Date.max(this.dragCreateDt, curr);
            ...
            if (data.type == 'eventresize') {
                ...
                curr = AboutUs.view.calendar.util.Date.copyTime(n.date, this.resizeDt);
                start = AboutUs.view.calendar.util.Date.min(data.eventStart, curr);
                end = AboutUs.view.calendar.util.Date.max(data.eventStart, curr);
