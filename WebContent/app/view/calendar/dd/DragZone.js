 ...
 */
Ext.define('AboutUs.view.calendar.dd.DragZone', {
    extend: 'Ext.dd.DragZone',

    requires: [
        'AboutUs.view.calendar.dd.StatusProxy',
    ...
    constructor: function(el, config) {
        if (!AboutUs.view.calendar._statusProxyInstance) {
            AboutUs.view.calendar._statusProxyInstance = new AboutUs.view.calendar.dd.StatusProxy();
        }
        this.proxy = AboutUs.view.calendar._statusProxyInstance;
    ...
    getDragData: function(e) {
        ...
        if (t) {
            ...
            return {
                type: 'eventdrag',
                ddel: t,
                eventStart: rec.data[AboutUs.view.calendar.data.EventMappings.StartDate.name],
                eventEnd: rec.data[AboutUs.view.calendar.data.EventMappings.EndDate.name],
                proxy: this.proxy
            };
        }
