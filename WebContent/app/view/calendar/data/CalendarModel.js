Ext.define('AboutUs.view.calendar.data.CalendarModel', {
    ...
    statics: {
        /**
         * Reconfigures the default record definition based on the current {@link AboutUs.view.calendar.data.CalendarMappings CalendarMappings}
         * object. See the header documentation for {@link AboutUs.view.calendar.data.CalendarMappings} for complete details and 
...
function() {
    AboutUs.view.calendar.data.CalendarModel.reconfigure();
});