/**
 * @class AboutUs.view.calendar.data.EventModel
 * @extends Ext.data.Record
 * <p>This is the {@link Ext.data.Record Record} specification for calendar event data used by the
 * {@link AboutUs.view.calendar.CalendarPanel CalendarPanel}'s underlying store. It can be overridden as 
...
rec = new AboutUs.view.calendar.data.EventModel({
 ...
 * If you have overridden any of the record's data mappings via the AboutUs.view.calendar.data.EventMappings object
 ...
 */
Ext.define('AboutUs.view.calendar.data.EventModel', {
    ...
    statics: {
        /**
         * Reconfigures the default record definition based on the current {@link AboutUs.view.calendar.data.EventMappings EventMappings}
         * object. See the header documentation for {@link AboutUs.view.calendar.data.EventMappings} for complete details and 
        ...
        reconfigure: function() {
            var Data = AboutUs.view.calendar.data,
...
function(){
    AboutUs.view.calendar.data.EventModel.reconfigure();
});