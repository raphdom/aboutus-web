 ...
 */
Ext.define('AboutUs.view.calendar.data.MemoryEventStore', {
    extend: 'Ext.data.Store',
    model: 'AboutUs.view.calendar.data.EventModel',
    ...
    constructor: function(config){
        ...
        this.sorters = this.sorters || [{
            property: AboutUs.view.calendar.data.EventMappings.StartDate.name,
            direction: 'ASC'
        }];
        
        this.idProperty = this.idProperty || AboutUs.view.calendar.data.EventMappings.EventId.mapping || 'id';
        this.fields = AboutUs.view.calendar.data.EventModel.prototype.fields.getRange();
    ...
    interceptCreateRecords: function(records, operation, success) {
        if (success) {
            ...
            for (; i < len; i++) {
                records[i].data[AboutUs.view.calendar.data.EventMappings.EventId.name] = records[i].id;
            }
        }
    },
