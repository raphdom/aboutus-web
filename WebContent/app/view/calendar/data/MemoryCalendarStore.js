 ...
 */
Ext.define('AboutUs.view.calendar.data.MemoryCalendarStore', {
    extend: 'Ext.data.Store',
    model: 'AboutUs.view.calendar.data.CalendarModel',
    
    requires: [
        'Ext.data.proxy.Memory',
        'Ext.data.reader.Json',
        'Ext.data.writer.Json',
        'AboutUs.view.calendar.data.CalendarModel',
    ...
    initComponent: function() {
        var me = this,
            calendarData = AboutUs.view.calendar.data;
