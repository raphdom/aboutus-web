/**
 * @class AboutUs.view.calendar.template.Month
 * @extends Ext.XTemplate
 * <p>This is the template used to render the {@link AboutUs.view.calendar.template.Month MonthView}. Internally this class defers to an
 ...
 */
Ext.define('AboutUs.view.calendar.template.Month', {
    ...
    constructor: function(config){
        ...
        this.weekTpl = new AboutUs.view.calendar.template.BoxLayout(config);
    ...
    applyTemplate : function(o){
        var days = [],
            ...
            dt = o.viewStart,
            D = AboutUs.view.calendar.util.Date;
