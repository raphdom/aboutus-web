/**
 * @class AboutUs.view.calendar.template.DayBody
 * @extends Ext.XTemplate
 * <p>This is the template used to render the scrolling body container used in {@link AboutUs.view.calendar.DayView DayView} and 
 * {@link AboutUs.view.calendar.WeekView WeekView}. This template is automatically bound to the underlying event store by the 
 ...
 * that internally creates an instance of this template along with a {@link AboutUs.view.calendar.DayHeaderTemplate}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('AboutUs.view.calendar.template.DayBody', {
    ...
    applyTemplate : function(o){
        this.today = AboutUs.view.calendar.util.Date.today();
        ...
        for(; i<this.dayCount; i++){
            days[i] = AboutUs.view.calendar.util.Date.add(dt, {days: i});
        }
        ...
        for(i=0; i<24; i++){
            ...
            dt = AboutUs.view.calendar.util.Date.add(dt, {hours: 1});
        }
