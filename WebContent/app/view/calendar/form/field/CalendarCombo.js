/**
 * @class AboutUs.view.calendar.form.field.CalendarCombo
 ...
 */
Ext.define('AboutUs.view.calendar.form.field.CalendarCombo', {
    extend: 'Ext.form.field.ComboBox',
    alias: 'widget.calendarpicker',
    requires: [
        'AboutUs.view.calendar.data.CalendarMappings'
    ],
    ...
    initComponent: function(){
        this.valueField = AboutUs.view.calendar.data.CalendarMappings.CalendarId.name;
        this.displayField = AboutUs.view.calendar.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function(displayField) {
        return '<div class="x-combo-list-item ext-color-{' + AboutUs.view.calendar.data.CalendarMappings.CalendarId.name +
    ...
    getStyleClass: function(value){
        ...
        if (!Ext.isEmpty(val)) {
            ...
            return 'ext-color-' + (val.data ? val.data[AboutUs.view.calendar.data.CalendarMappings.CalendarId.name] : val); 
        }
        return '';
    },
    ...
    setValue: function(value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[AboutUs.view.calendar.data.CalendarMappings.CalendarId.name];
        }
