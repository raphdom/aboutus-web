 ...
 */
Ext.define('AboutUs.view.calendar.form.field.DateRange', {
     ...
     */
    getValue: function(){
        var eDate = AboutUs.view.calendar.util.Date,
     ...
     * as defined in {@link AboutUs.view.calendar.data.EventMappings}.</div></li><ul></div>
     */
    setValue: function(v){
        if(!v) {
            return;
        ...
        else if(v[AboutUs.view.calendar.data.EventMappings.StartDate.name]){ //object
            this.setDT(v[AboutUs.view.calendar.data.EventMappings.StartDate.name], 'start');
            if(!this.setDT(v[AboutUs.view.calendar.data.EventMappings.EndDate.name], 'end')){
                this.setDT(v[AboutUs.view.calendar.data.EventMappings.StartDate.name], 'end');
            }
            this.allDay.setValue(!!v[AboutUs.view.calendar.data.EventMappings.IsAllDay.name]);
        }
    },
