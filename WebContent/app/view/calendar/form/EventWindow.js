/**
 * @class AboutUs.view.calendar.form.EventWindow
 * @extends Ext.Window
 ...
 */
Ext.define('AboutUs.view.calendar.form.EventWindow', {
    ...
    requires: [
        ...
        'AboutUs.view.calendar.data.EventModel',
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {AboutUs.view.calendar.form.EventWindow} this
             ...
             * (by default, an instance of {@link AboutUs.view.calendar.EventEditForm}. Handling code should hide this window
             * and transfer the current event record to the appropriate instance of the detailed form by showing it
             * and calling {@link AboutUs.view.calendar.EventEditForm#loadRecord loadRecord}.
             * @param {AboutUs.view.calendar.form.EventWindow} this
             * @param {AboutUs.view.calendar.EventRecord} rec The {@link AboutUs.view.calendar.EventRecord record} that is currently being edited
             */
            editdetails: true
        });
    },
    ...
    show: function(o, animateTarget) {
        ...
        if (o.data) {
            ...
            var start = o[M.StartDate.name],
                end = o[M.EndDate.name] || AboutUs.view.calendar.util.Date.add(start, {hours: 1});

            rec = Ext.create('AboutUs.view.calendar.data.EventModel');
            rec.data[M.StartDate.name] = start;
            rec.data[M.EndDate.name] = end;
            rec.data[M.IsAllDay.name] = !!o[M.IsAllDay.name] || start.getDate() != AboutUs.view.calendar.util.Date.add(end, {millis: 1}).getDate();
