/**
 * @class AboutUs.view.calendar.form.EventDetails
 ...
 * calendar components. It is also configured to automatically bind records of type {@link AboutUs.view.calendar.EventRecord}
 ...
 */
Ext.define('AboutUs.view.calendar.form.EventDetails', {
    extend: 'Ext.form.Panel',
    alias: 'widget.eventeditform',
    
    requires: [
        'AboutUs.view.calendar.form.field.DateRange',
        'AboutUs.view.calendar.form.field.ReminderCombo',
        'AboutUs.view.calendar.data.EventMappings',
        'AboutUs.view.calendar.form.field.CalendarCombo'
    ],
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {AboutUs.view.calendar.form.EventDetails} this
             ...
             * @param {AboutUs.view.calendar.form.EventDetails} this
             * @param {AboutUs.view.calendar.EventRecord} rec The new {@link AboutUs.view.calendar.EventRecord record} that was deleted
             */
            eventdelete: true,
            /**
             * @event eventcancel
        ...
        this.titleField = new Ext.form.Text({
            fieldLabel: 'Title',
            name: AboutUs.view.calendar.data.EventMappings.Title.name,
            emptyText: 'Event Title',
            allowBlank: false,
            anchor: '90%'
        });
        this.dateRangeField = new AboutUs.view.calendar.form.field.DateRange({
            fieldLabel: 'When',
            singleLine: false,
            anchor: '90%'
        });
        this.reminderField = new AboutUs.view.calendar.form.field.ReminderCombo({
            name: 'Reminder',
            anchor: '70%'
        });
        this.notesField = new Ext.form.TextArea({
            fieldLabel: 'Notes',
            name: AboutUs.view.calendar.data.EventMappings.Notes.name,
            grow: true,
            growMax: 150,
            anchor: '100%'
        });
        this.locationField = new Ext.form.Text({
            fieldLabel: 'Location',
            name: AboutUs.view.calendar.data.EventMappings.Location.name,
            anchor: '100%'
        });
        this.urlField = new Ext.form.Text({
            fieldLabel: 'Web Link',
            name: AboutUs.view.calendar.data.EventMappings.Url.name,
            anchor: '100%'
        });
        ...
        if (this.calendarStore) {
            this.calendarField = new AboutUs.view.calendar.form.field.CalendarCombo({
                store: this.calendarStore,
                anchor: '70%',
                name: AboutUs.view.calendar.data.EventMappings.CalendarId.name
            });
    ...
    loadRecord: function(rec){
        ...
        if(this.calendarStore){
            this.form.setValues({
                'calendar': rec.data[AboutUs.view.calendar.data.EventMappings.CalendarId.name]
            });
        }
