/**
 * @class AboutUs.view.calendar.view.Day
 * @extends Ext.container.Container
 * <p>Unlike other calendar views, is not actually a subclass of {@link AboutUs.view.calendar.view.AbstractCalendar AbstractCalendar}.
 * Instead it is a {@link Ext.container.Container Container} subclass that internally creates and manages the layouts of
 * a {@link AboutUs.view.calendar.DayHeaderView DayHeaderView} and a {@link AboutUs.view.calendar.DayBodyView DayBodyView}. As such
 ...
 */
Ext.define('AboutUs.view.calendar.view.Day', {
    extend: 'Ext.container.Container',
    alias: 'widget.dayview',
    
    requires: [
        'AboutUs.view.calendar.view.AbstractCalendar',
        'AboutUs.view.calendar.view.DayHeader',
        'AboutUs.view.calendar.view.DayBody'
    ],
