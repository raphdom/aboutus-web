/**S
 * @class AboutUs.view.calendar.view.DayBody
 * @extends AboutUs.view.calendar.view.AbstractCalendar
 * <p>This is the scrolling container within the day and week views where non-all-day events are displayed.
 * Normally you should not need to use this class directly -- instead you should use {@link AboutUs.view.calendar.DayView DayView}
 * which aggregates this class and the {@link AboutUs.view.calendar.DayHeaderView DayHeaderView} into the single unified view
 * presented by {@link AboutUs.view.calendar.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('AboutUs.view.calendar.view.DayBody', {
    extend: 'AboutUs.view.calendar.view.AbstractCalendar',
    alias: 'widget.daybodyview',

    requires: [
        'Ext.XTemplate',
        'AboutUs.view.calendar.template.DayBody',
        'AboutUs.view.calendar.data.EventMappings',
        'AboutUs.view.calendar.dd.DayDragZone',
        'AboutUs.view.calendar.dd.DayDropZone'
    ],
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {AboutUs.view.calendar.view.DayBody} this
    ...
    initDD: function() {
        ...
        this.dragZone = new AboutUs.view.calendar.dd.DayDragZone(this.el, Ext.apply({
            view: this,
            containerScroll: true
        },
        cfg));

        this.dropZone = new AboutUs.view.calendar.dd.DayDropZone(this.el, Ext.apply({
            view: this
        },
        cfg));
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new AboutUs.view.calendar.template.DayBody({
                id: this.id,
    ...
    onEventResize: function(rec, data) {
        var D = AboutUs.view.calendar.util.Date,
        start = AboutUs.view.calendar.data.EventMappings.StartDate.name,
        end = AboutUs.view.calendar.data.EventMappings.EndDate.name;
     ...
     * {@link AboutUs.view.calendar.EventRecord}) to populate the calendar views with <strong>all-day</strong> events. 
    ...
    getTemplateEventData: function(evt) {
        var selector = this.getEventSelectorCls(evt[AboutUs.view.calendar.data.EventMappings.EventId.name]),
            data = {},
    ...
    getTemplateEventBox: function(evt) {
        var heightFactor = 0.7,
            start = evt[AboutUs.view.calendar.data.EventMappings.StartDate.name],
            end = evt[AboutUs.view.calendar.data.EventMappings.EndDate.name],
        ...
        for (; day < this.dayCount; day++) {
            ...
            for (; ev < ct; ev++) {
                ...
                evts.push({
                    ...
                    date: AboutUs.view.calendar.util.Date.add(this.viewStart, {days: day})
                });
            }
        }
    ...
    getDayAt: function(x, y) {
        var xoffset = this.el.down('.ext-cal-day-times').getWidth(),
            ...
            mins = rowIndex * 30,
            dt = AboutUs.view.calendar.util.Date.add(this.viewStart, {days: dayIndex, minutes: mins}),
            el = this.getDayEl(dt),
            timeX = x;
    ...
    onClick: function(e, t) {
        if (this.dragPending || AboutUs.view.calendar.view.DayBody.superclass.onClick.apply(this, arguments)) {
