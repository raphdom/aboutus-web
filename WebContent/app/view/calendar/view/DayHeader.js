/**
 * @class AboutUs.view.calendar.view.DayHeader
 * @extends AboutUs.view.calendar.MonthView
 ...
 * which aggregates this class and the {@link AboutUs.view.calendar.DayBodyView DayBodyView} into the single unified view
 * presented by {@link AboutUs.view.calendar.CalendarPanel CalendarPanel}.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('AboutUs.view.calendar.view.DayHeader', {
    extend: 'AboutUs.view.calendar.view.Month',
    alias: 'widget.dayheaderview',

    requires: [
        'AboutUs.view.calendar.template.DayHeader'
    ],
     ...
     * @param {AboutUs.view.calendar.DayBodyView} this
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new AboutUs.view.calendar.template.DayHeader({
                id: this.id,
