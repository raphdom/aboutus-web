/**
 * @class AboutUs.view.calendar.view.Month
 * @extends AboutUs.view.calendar.CalendarView
 * <p>Displays a calendar view by month. This class does not usually need ot be used directly as you can
 * use a {@link AboutUs.view.calendar.CalendarPanel CalendarPanel} to manage multiple calendar views at once including
 * the month view.</p>
 * @constructor
 * @param {Object} config The config object
 */
Ext.define('AboutUs.view.calendar.view.Month', {
    extend: 'AboutUs.view.calendar.view.AbstractCalendar',
    alias: 'widget.monthview',
    
    requires: [
        'Ext.XTemplate',
        'AboutUs.view.calendar.template.Month',
        'AboutUs.view.calendar.util.WeekEventRenderer',
        'AboutUs.view.calendar.view.MonthDayDetail'
    ],
     ...
     * True to display an extra column before the first day in the calendar that links to the {@link AboutUs.view.calendar.WeekView view}
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {AboutUs.view.calendar.view.Month} this
    ...
    initDD: function() {
        ...
        this.dragZone = new AboutUs.view.calendar.dd.DragZone(this.el, cfg);
        this.dropZone = new AboutUs.view.calendar.dd.DropZone(this.el, cfg);
    },
    ...
    afterRender: function() {
        if (!this.tpl) {
            this.tpl = new AboutUs.view.calendar.template.Month({
                id: this.id,
    ...
    renderItems: function() {
        AboutUs.view.calendar.util.WeekEventRenderer.render({
    ...
    getDayAt: function(x, y) {
        var box = this.el.getBox(),
            ...
            days = (dayT * 7) + dayL,
            dt = AboutUs.view.calendar.util.Date.add(this.viewStart, {days: days});
        return {
            date: dt,
            el: this.getDayEl(dt)
        };
    ...
    onClick: function(e, t) {
        ...
        if (AboutUs.view.calendar.view.Month.superclass.onClick.apply(this, arguments)) {
