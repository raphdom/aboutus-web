/**
 * @class AboutUs.view.calendar.CalendarPanel
 * @extends Ext.Panel
 ...
 * {@link #calendarStore} config containing records of type {@link AboutUs.view.calendar.EventRecord EventRecord}. In order
 ...
 * @xtype calendarpanel
 */
Ext.define('AboutUs.view.calendar.CalendarPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.calendarpanel',
    
    requires: [
        'Ext.layout.container.Card',
        'AboutUs.view.calendar.view.Day',
        'AboutUs.view.calendar.view.Week',
        'AboutUs.view.calendar.view.Month',
        'AboutUs.view.calendar.form.EventDetails',
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {AboutUs.view.calendar.CalendarPanel} this
             * @param {AboutUs.view.calendar.EventRecord} rec The new {@link AboutUs.view.calendar.EventRecord record} that was added
             */
            eventadd: true,
            /**
             * @event eventupdate
             ...
             * @param {AboutUs.view.calendar.CalendarPanel} this
             * @param {AboutUs.view.calendar.EventRecord} rec The new {@link AboutUs.view.calendar.EventRecord record} that was updated
             */
            eventupdate: true,
            /**
             * @event eventdelete
             ...
             * @param {AboutUs.view.calendar.CalendarPanel} this
             * @param {AboutUs.view.calendar.EventRecord} rec The new {@link AboutUs.view.calendar.EventRecord record} that was removed
             */
            eventdelete: true,
            /**
             * @event eventcancel
             ...
             * @param {AboutUs.view.calendar.CalendarPanel} this
             * @param {AboutUs.view.calendar.EventRecord} rec The new {@link AboutUs.view.calendar.EventRecord record} that was canceled
             */
            eventcancel: true,
            /**
             * @event viewchange
             ...
             * @param {AboutUs.view.calendar.CalendarPanel} this
             * @param {Ext.AboutUs.view.calendar.view.AbstractCalendar} view The view being activated (any valid {@link AboutUs.view.calendar.view.AbstractCalendar AbstractCalendar} subclass)
             ...
             * @param {AboutUs.view.calendar.CalendarPanel} this
             * @param {AboutUs.view.calendar.EventRecord} rec The {@link AboutUs.view.calendar.EventRecord record} for the event that was resized
    ...
    onEventAdd: function(form, rec) {
        rec.data[AboutUs.view.calendar.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
     ...
     * @param {AboutUs.view.calendar.EventRecord} record The event record to edit
     * @return {AboutUs.view.calendar.CalendarPanel} this
     */
     ...
     * {@link AboutUs.view.calendar.view.AbstractCalendar AbstractCalendar}.
     * @return {AboutUs.view.calendar.view.AbstractCalendar} The active view
     */
