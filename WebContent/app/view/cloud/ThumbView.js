        ...
        '<tpl for=".">',
            '<div class="thumb-wrap" id="{filename:stripTags}">',
                '<div class="{classThumb}">',
                	'<img src="{id:formatThumbUrl(2,values.fileType)}" onerror="if (this.src != \'{id:getDefaultIcon(2,values.fileType)}\') this.src = \'{id:getDefaultIcon(2,values.fileType)}\';" title="{filename:htmlEncode}">',
                '</div>',
